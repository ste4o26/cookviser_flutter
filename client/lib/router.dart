...
class AppRouter {
  ...
  late final GoRouter _router = GoRouter(
    routes: <GoRoute>[
      GoRoute(
          path: Routes.cuisines.name, builder: (context, state) => const CuisinesPage()),
      GoRoute(
      ...
      GoRoute(path: Routes.root.name, redirect: (context, state) => Routes.home.name),
      GoRoute(path: Routes.home.name, builder: (context, state) => const HomePage()),
      GoRoute(
